...
const rawData = [
  ...
  },
  {
    type: "R.309",
    name: "Ấn còi",
    content: "Biển báo lệnh cho người lái xe phải bấm còi.",
  ...
  },
  {
    ...
    content: "Biển báo hiệu bắt đầu đường dành cho các loại ôtô đi lại.",
  ...
  },
  {
    ...
    content: "Đến hết đoạn đường dành cho ôtô đi lại",
    image: require("../../assets/Bienbaohieulenh/signR404a.png"),
  },
  {
    type: "R.404b",
    name: "Hết đoạn đường dành cho ôtô và xe máy",
    content: "Đến hết đoạn đường dành cho ôtô, xe máy đi lại",
  ...
  },
  {
    ...
    content: "Chỉ dẫn đoạn đường qua hầm có áp dụng quy định giao thông riêng.",
