...
const LuatOto = ({ navigation }) => {
  ...
  const handleOption = (item) => {
    switch (item.id) {
      case "1":
        navigation.navigate("HieulenhchidanOT");
        break;
      case "2":
        navigation.navigate("ChuyenhuongOT");
        break;
      case "3":
        navigation.navigate("DungxeOT");
        break;
      case "4":
        navigation.navigate("ThietbiuutienOT");
        break;
      case "5":
        navigation.navigate("TocdoOT");
        break;
      case "6":
        navigation.navigate("VanchuyenOT");
        break;
      case "7":
        navigation.navigate("TrangthietbiOT");
        break;
      case "8":
        navigation.navigate("DuongcamOT");
        break;
      case "9":
        navigation.navigate("NongdoconOT");
        break;
      case "10":
        navigation.navigate("GiaytoxeOT");
        break;
      case "11":
        navigation.navigate("KhacOT");
        break;
      default:
