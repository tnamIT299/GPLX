        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.contentContainer}>
                <View style={styles.section}>
                    ...
                    <Text style={styles.contentText}>Phần này có các mục: Đi vòng số 8 , đường thẳng, zích zắc và đường mấp mô</Text>
                    <Text style={styles.contentText}>* Lưu ý: Bạn nên nổ sẵng xe máy và để số 3, xong xếp hàng đợi đến lượt
                        mình thi nhé</Text>
                </View>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionHeader}>  – Hình 03: Đường đi vòng vèo</Text>
                    <Text style={styles.contentText}> Gọi là đường vòng vèo nhưng nó không quanh co chút nào, ứng viên chỉ cần
                        hơi lượn tay lái theo vạch vẽ sẵn là được. Hình này khi đi bạn cần chú ý
                        về tốc độ.</Text>
                </View>

                <View style={styles.section}>
                    <Text style={styles.sectionHeader}> – Hình 04: Đường thẳng gồ gề</Text>
                    <Text style={styles.contentText}>Đi xong hình một các bạn đi tiếp luôn hình 02, là đường thẳng ghồ ghề.
                        Hình này thì dễ hơn, chỉ cần giữ vững tay lái thẳng lái là đi qua dễ dàng.</Text>
                </View>
